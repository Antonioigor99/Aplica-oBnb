  ...
  return (
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-8">
        ...
        <Link
          to="/"
          className="hidden items-center gap-2 rounded-full border border-gray-300 py-2 pr-4 pl-6 shadow-md lg:flex"
        >
        ...
        >
          ...
          <p className="max-w-20 truncate sm:max-w-28">Antonio Igor</p>
        </Link>
      </div>
    </header>
  );
